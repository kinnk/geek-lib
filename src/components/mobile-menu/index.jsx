...
export default function MobileMneu({ isOpen }) {
  return (
    <>
      <div className={`absolute top-0 left-[-50%] right-0 bg-black opacity-50 min-h-screen min-w-[150vw] z-30 ${isOpen ? 'flex' : 'hidden'}`}/>
      <div className={`absolute top-0 right-0 bg-white dark:bg-slate-800 min-h-screen w-1/3 z-40 ${isOpen ? 'flex' : 'hidden'}
