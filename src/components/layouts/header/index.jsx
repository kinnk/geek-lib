...
export default function Header() {
  ...
  return (
    <header className="shadow-xl bg-white flex items-center justify-between py-2 px-4 xl:px-10 opacity-90 z-20 duration-500 dark:bg-slate-800 space-x-2 top-0 sticky">
