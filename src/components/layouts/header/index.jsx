...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between md:justify-around xl:justify-around py-4 px-2 sticky duration-500 dark:bg-slate-800 dark:text-white ">
      ...
      <div className="hidden lg:flex items-center space-x-4">
        <DarkmodeButtons />
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-9 h-9 text-slate-400">
