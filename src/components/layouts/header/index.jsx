...
export default function Header() {
  ...
  return (
    <header className="shadow-xl z-20 duration-500 bg-white/90 dark:bg-slate-800/90 space-x-2 top-0 sticky backdrop-blur-sm">
      <div className="container mx-auto py-2 px-2 flex items-center justify-between">
        <div>
          <h1 className="font-bold text-2xl tracking-widest dark:text-white">GeekLib</h1>
        </div>
        {/* Navigation */}
